          ...
          <div>
            <div className="show-container-all">
              ...
              <div className="show-details-container">
                ...
                {/* <PickItemsFormContainer productId={product.id}/> */}
                {this.state.form ? (
                  <PickItemsFormContainer productId={product.id} />
                ) : (
                  ""
                ...
                <div className="show-extra-details">
                  <div className="show-stylsit-notes">
                    <p
                      className="show-deets cursor"
                      onClick={this.dropInfo("stylistNotes")}
                    >
                    ...
                    <p className="show-hidden-info">
                      {" "}
                      {this.state.stylistNotes
                        ? product.stylist_notes
                        : ""}{" "}
                    </p>
                  </div>
                  <div className="show-size-fit cursor">
                    <p
                      className="show-deets"
                      onClick={this.dropInfo("sizeFit")}
                    >
                      <span> SIZE &amp; FIT </span>
                      <img className="show-plus" src={window.images.plus} />
                    </p>
                    <p className="show-hidden-info">
                      {this.state.sizeFit ? product.size_fit : ""}{" "}
                    </p>
                  </div>
                  <div className="show-product-details cursor">
                    <p
                      className="show-deets"
                      onClick={this.dropInfo("productDetails")}
                    >
                      <span> PRODUCT DETAILS </span>
                      <img className="show-plus" src={window.images.plus} />
                    </p>
                    <p className="show-hidden-info">
                      {this.state.productDetails ? product.product_details : ""}{" "}
                    </p>
                  </div>
                  <div className="show-erin-social cursor">
                    <p
                      className="show-deets"
                      onClick={this.dropInfo("meetDeveloper")}
                    >
                      <span> MEET THE DEVELOPER </span>
                      <img className="show-plus" src={window.images.plus} />
                    </p>
                    <p className="show-hidden-info">
                      {this.state.meetDeveloper ? (
                        <a
                          href="https://www.linkedin.com/in/erinicole1988/"
                          target="_blank"
                          className="a-link"
                        >
                          <img
                            id="show-linkedin"
                            src={window.images.linkedin}
                          />
                        </a>
                      ) : (
                        ""
